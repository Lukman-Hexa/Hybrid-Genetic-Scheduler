...
// ===== DISPLAY RESULTS ===== (⭐ FIXED - Menampilkan kedua hasil)
function displayResults(result) {
    ...
    // ⭐ Tampilkan perbandingan jika ada - DENGAN KEDUA HASIL LENGKAP
    ...
    // ⭐ Tampilkan SEMUA semester dari hasil terbaik (struktur data sudah berisi semua semester)
    ...
    // Render jadwal untuk setiap semester (dari hasil terbaik)
    semesters.forEach(sem => {
    ...
    // ⭐ TAMBAHKAN: Jika mode perbandingan, tampilkan juga tab untuk hasil GA Murni
    if (result.comparison) {
        // Buat container untuk tab hasil GA Murni
        ...
        // Buat container untuk hasil GA+Greedy
